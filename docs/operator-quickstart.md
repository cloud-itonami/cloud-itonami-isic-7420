# Operator Quickstart — Photographic activities

Shortest path from clone to a verified local dry-run for **ISIC 7420** (`cloud-itonami-isic-7420`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7420.git
cd cloud-itonami-isic-7420
```
...
- Blueprint governor key: `shoot-delivery-governor`
- Likely source path: `photo.governor.cljc`
