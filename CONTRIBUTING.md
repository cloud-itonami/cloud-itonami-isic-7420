...
`cloud-itonami-isic-7420` accepts contributions to the OSS blueprint, capability
...
- Keep delivering/licensing a final image set to a client behind the Shoot Delivery Governor.
